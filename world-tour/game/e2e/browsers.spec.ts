...
// The game's name has one owner, the English locale (the page opens in English here).
const TITLE = (JSON.parse(readFileSync(resolve('src/ui/locales/en.json'), 'utf8')) as Record<string, string>)['app.title']!;
