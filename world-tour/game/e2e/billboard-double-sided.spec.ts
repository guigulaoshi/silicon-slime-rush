...
// new-york: dense city route (game/public/tracks/new-york/track.json), replacing
// fishermans-wharf (deleted with the Bay Area tracks) as the busy-city test bed for both
// billboard mounting styles.
for (const [style, route] of [['ground', 'new-york'], ['pole', 'new-york']] as const) {
