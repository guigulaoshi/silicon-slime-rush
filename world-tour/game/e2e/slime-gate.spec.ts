...
// Deleted: "direct Lombard road view contains dense four-colour flower beds" tested Lombard's
// hydrangea flower beds, a feature deleted with the Bay Area tracks (no new track has it).
