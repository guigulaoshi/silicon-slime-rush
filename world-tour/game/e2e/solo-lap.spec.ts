 ...
 */
// fishermans-wharf was retired; this benchmark only needs an ordinary p2p route to drive a
// racing line on, not anything about a waterfront or city traffic, so lhasa (flat, day, no
// quirks) stands in for the old "any normal track" default.
const TRACK = process.env.SOLO_TRACK ?? 'lhasa';
