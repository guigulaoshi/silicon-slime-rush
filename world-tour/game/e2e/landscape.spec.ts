...
test.describe('phone landscape', () => {
  ...
  // shoreline (an open flat campus route) -> lhasa (flat high valley boulevard): this test only
  // needs a real, ordinary track to drive while it exercises rotation/pause behaviour.
