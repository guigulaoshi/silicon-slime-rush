...
test('pauses, resumes, and goes back to the menu', async ({ page }) => {
  ...
  // Golden Gate was deleted with the Bay Area tracks; this test only needs a real track to race
  // on, no particular geometry -- Sydney is the world-tour default/showcase track.
  await page.goto('/?track=sydney');
