...
export const SOCIAL_TITLE = 'Silicon Slime Rush: World Tour · 史莱姆赛车：环游世界';
export const SOCIAL_DESCRIPTION =
  '开上全球十三座名城的真实街道，撞穿史莱姆，闯过末日第一天的早高峰。'
  + 'Race the real streets of thirteen world cities through the slime apocalypse. Free in your browser.';
/**
...
export function socialMetaTags(home: string, image: string = SOCIAL_IMAGE): string {
  const tags: [string, string, string][] = [
    ...
    ['property', 'og:site_name', 'Silicon Slime Rush: World Tour'],
