...
/** Build metadata comes from game/package.json (the one owner of the version) and installed packages. */
...
export function buildCredits(root: string, changes: (root: string) => string = gitChanges) {
  ...
  if (!version) throw new Error('game/package.json has no version');
