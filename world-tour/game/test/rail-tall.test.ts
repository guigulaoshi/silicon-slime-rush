...
// The Moffett rail fixture is the generator's own mesh (beam 0.16-0.48 m, at x = 30.8), kept as
// historical fixture data though moffett-field itself is gone with the rest of the Bay Area set.
// Lifting it 0.24 m gives the ordinary 0.40-0.72 m rail every other route uses.
