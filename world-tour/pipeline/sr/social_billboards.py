...
SOURCE = ROOT / "pipeline" / "assets" / "social-billboards"
...
def build_all():
    ...
    for channel in load_channels():
        for language in ("zh", "en"):
            ...
            if path in written:
                continue
            # A platform's board is reached through more than one slot and copy (rotates
            # four Chinese and three English platforms over seven slots). It is set in the platform's own language
