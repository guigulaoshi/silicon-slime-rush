...
def test_portal_yaw_puts_its_long_axis_across_the_road():
    """A suspension bridge's portal joins its two legs; it never projects forward over the traffic."""
...
def test_the_ironwork_does_not_quietly_multiply():
    ...
    the affected route's tile pack nearly doubled in size from perfectly coincident steel, drawn on
