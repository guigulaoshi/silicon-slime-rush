...
const EN = 'SILICON SLIME RUSH', ZH = '史莱姆赛车：硅谷';
const MENU_WORDMARK = 'Silicon Slime Rush';

it('names the game in the current language only, and follows a language switch', () => {
  const t = new I18n('en');
  const facts = { trackId: 'shoreline', time: 20, best: null, isBest: false, score: 0, slimeHits: 0, rating: 3 as const };
  const pages = [
    home(t, () => {}, () => {}, () => {}, () => {}, 0),
