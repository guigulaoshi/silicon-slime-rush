 ...
 * because a bus with its throttle pinned and no brakes pins itself against the first rail (measured:
 * stopped at 904 m of fishermans-wharf). Records every racer's finish time and the sports car's throttle use on straights.
