 ...
 *
 *   SHOT_TRACK=lombard SHOT_AT=1240 SHOT_NAME=01-hairpins npx playwright test e2e/shot.spec.ts
 *
 ...
 *
 * The baseline suite photographs Golden Gate on a fixed list; this is for looking at anywhere else
