...
export const SKY_PRESETS: Record<TimeOfDay, SkyPreset> = {
  day: { elevation: 46, azimuth: 218, sunColor: 0xfff1dc, sunIntensity: 2.9, skyColor: 0x7da9d1,
    zenithColor: 0x1371c8, groundColor: 0x6d6b5c, ambient: 0.55, fogColor: 0x6c96c9,
...
export class Sky {
  ...
  constructor(private readonly scene: THREE.Scene, readonly timeOfDay: TimeOfDay, shadowRadius = 90,
    viewRadius?: number, readonly weather: Weather = 'clear', horizonRadius?: number) {
    const preset = SKY_PRESETS[timeOfDay] ?? SKY_PRESETS.day;
