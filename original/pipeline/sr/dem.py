...
from sr.fetch_dem import ZOOM, decode, tile_path


class DemSampler:
    """Samples cached Terrarium tiles. Points with no cached tile read as 0 m (open ocean is 0 anyway)."""

    def __init__(self, zoom=ZOOM, require_complete=False):
        self.zoom = zoom
