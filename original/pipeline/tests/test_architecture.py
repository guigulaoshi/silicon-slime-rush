...
def test_valley_houses_use_the_existing_roof_choice(roof,expected):
    assert house_style("wolfe-pruneridge",roof,7) == expected
    assert house_style("twin-peaks",roof,9) == "bay-front"
    assert house_style("fishermans-wharf",roof,12) == "bay-front"
