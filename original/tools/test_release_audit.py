...
def test_an_address_in_obfuscated_code_stops_at_its_own_quote():
    ...
    body = ("var a='https://guigulaoshi.itch.io/silicon-slime-rush';function f(){}"
            ...
            '<a href="https://www.sfrecpark.org/Facilities/Facility/Details/Twin-Peaks-338">x</a>'
            "See [the map](https://www.openstreetmap.org/copyright). Plain https://example.com/path, then more."
            "list.filter(u=>u.startsWith('https://'));"
            "m={'lombard':'https://www.sftravel.com/lombard-street','moffett-field':'https://nasa.example/hangar1'};")
    assert release_audit.addresses(body) == {
        ...
        "https://example.org/a",
        "https://www.sfrecpark.org/Facilities/Facility/Details/Twin-Peaks-338",
        "https://www.openstreetmap.org/copyright",
        "https://example.com/path",
        "https://www.sftravel.com/lombard-street",
        "https://nasa.example/hangar1",
    }
